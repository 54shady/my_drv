...
//	s3c_lcd->var.bits_per_pixel = 24;//这样写有错误,不理解
	...
	*gpgcon |= (3<<8); /* GPG4用作LCD_PWREN */
	 ...
	 *            CLKVAL = 8
	 * bit[6:5]: 11, TFT LCD
	 * bit[4:1]: 1100, 16 bpp for TFT  1101 24 bpp
	 * bit[0]  : 0 = Disable the video output and the LCD control signal.
	 */
	lcd_regs->lcdcon1  = (8<<8) | (3<<5) | (0x0d<<1);//CLKVAL = 8
	 ...
	 *             LCD手册 tvb=18
	 *             VBPD=17
	 * bit[23:14]: 多少列, 320, 所以LINEVAL=320-1=319
	...
	/* 信号的极性 
	 * bit[11]: 1=565 format  0 5:5:5:1 Format
	 * bit[10]: 1 = The video data is fetched at VCLK rising edge
